...
if isinstance(r2s.Lsval, tuple):

    u= orbitals.u_irr_transformation(np.shape(h)[0], r2s.Lsval, r2s.basis_tag, irr_flag=r2s.irr_flag,
                                  verbose_text=r2s.verbose_text)
else:
    u = orbitals.get_u_transformation(np.shape(h)[0], r2s.basis_tag, r2s.cubic,
...
if isinstance(r2s.Lsval, tuple):
    hOperator = h2imp.get_H_operator_from_dense_rspt_H_matrix(h_sph, r2s.Lsval)
else:
